	...
	<div class="modal-window modal-dialog animate__animated animate__fadeInDownBig animate__faster" onclick="f_block()" >
		<div class="modal-content ">
			...
			<div class="modal-body">
				...
				<table id="tableDetailChart">
					<tr>
						<th>진료차트코드</th>
						<td id="tbTrmCd" class="form-control"></td>
					</tr>
					<tr>
						<th>진료일자</th>
						<td id="tbTrmDate" class="form-control"></td>
					</tr>
					<tr>
						<th>담당의사</th>
						<td id="tbTrmEmp" class="form-control"> </td>
					</tr>
					<tr>
						<th>의무기록</th>
						<td id="tbTrmDetail" class="form-control"></td>
					</tr>					
					<tr>
						<table>
			...
			<div class="grid-stack-item-content card-grid" >
				...
				<div class="tabcontentWrap tab-bigger">
					<div class="tabcontent">
						...
						<input class="btn btn-secondary" type="button" value="등록" />
					</div>
				</div>
			</div>	
		</div>	
...
// 			, $("<tr>").append($("<th>").html("증상"), $("<td>").html(f_listTable(v_data.symptomVOList)))
// 			, $("<tr>").append($("<th>").html("진단"), $("<td>").html(f_listTable(v_data.diagHistoryVOList,"icdName")))
// 			, $("<tr>").append($("<th>").html("처방"), $("<td>").html(f_listTable(v_data.prescriptionVOList,"preCd")))
// 			, $("<tr>").append($("<th>").html("촬영"), $("<td>").html(f_listTable(v_data.filmOrderVOList,"filmCd")))
