	...
	<div class="content-center">
		...
		<div class="cex-barcode oper-card card-grid">
			...
			<h4 class="h4-title2">검사결과상세</h4>
				<table id="cex-detail-table">
					<tr>
						<th>검사코드</th>
						<td><input type="text" class="form-control-plaintext" id="cex-detail-cexNo" readonly="readonly"></td>
					</tr>
					<tr>
						<th>환자번호</th>
						<td><input type="text" class="form-control-plaintext" id="cex-detail-paNo" readonly="readonly"></td>
					</tr>
					<tr>
						<th>환자명</th>
						<td><input type="text" class="form-control-plaintext" id="cex-detail-paName" readonly="readonly"></td>
					</tr>
				</table>
				<table class="table-blue">
					<thead class="fixedHeadr">
		...
		<div class="cex-input oper-card card-grid">
			...
			<table class="cex-input-table">
				<tr>
					<td>검사코드</td>
					<td colspan="2"><input type="text" class="form-control" id="cex-input-cexNo" readonly="readonly"></td>
				</tr>
				<tr>
					<td>혈액검사</td>
					<td class="td-center">
